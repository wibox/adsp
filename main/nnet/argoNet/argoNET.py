...
class UNet(nn.Module):
    def __init__(self, encoder, feature_channels, n_classes, concat_mult=2, bilinear=True, dropout_rate=0.5):
        ...
        Args:
            ...
            Note per inizializzazione (GAFES):
                - encoder -> quello pre-trainato da repo! (controllare quale)
                - feature_channels -> 12 :D
                - n_classes -> 2
                - concat_mult -> fare test
                - bilinear -> lasciare true
                - dropout_rate -> lasciare .5 (o fare test)
        """
