...
if __name__ == "__main__":
	print(colored("Fine-Tuning and testing UNET over ImageNet pretrain.", "green"))
	...
	criterion = torch.nn.BCEWithLogitsLoss(pos_weight=torch.tensor(0.7))
	...
	print("Saving model...")
	torch.save(model.state_dict(), "models/trained_models/imagenet.pth")